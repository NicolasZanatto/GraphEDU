...
export const AtualizarGrafoDIJKSTRA = (verticeInicial, verticeFinal, nodes, links, simulacao) => {
    ...
    .duration(500)
    .attr("fill", vertice => {
        const caminho = simulacao.dijkstra.caminho[simulacao.passo]
        ...
        if (caminho.conjuntoQ.includes(vertice.id)) {
