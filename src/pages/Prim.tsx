...
import PrimPseudoCodigo from "../components/pseudo-codigo/PrimPseudoCodigo";
import { makeStyles } from '@material-ui/core/styles';
import Grid from '@material-ui/core/Grid';
import * as SimulacaoActions from "../store/actions/simulacaoAction";
import { IState } from "../store/types";
import { EAlgoritmos } from '../Algoritmos/EAlgoritmos';
import LegendasPrim from "../components/canvas/legendas/LegendasPRIM";
import { MenuLateral } from './common/MenuLateral';
import PRIMCamposAdicionais from '../components/campos-adicionais/PRIMCamposAdicionais';
...
const Prim = (props: Props) => {
    ...
    if (useFirstRender())
        props.SetAlgoritmoAction(EAlgoritmos.PRIM);
            ...
            <Grid container spacing={2}>
                <Grid item xs={6}>
                    <Grid container className={classes.canvas}>
                        <Grid item xs={12}>
                        <InformacoesGrafo eAlgoritmo={EAlgoritmos.PRIM}></InformacoesGrafo>
                        </Grid>
                        <Grid item xs={12}>
                            <LegendasPrim></LegendasPrim>
                        </Grid>
                        <Grid item xs={12}>
                            <Canvas></Canvas>
                        </Grid>
                ...
                <Grid item xs={4}>
                    <PrimPseudoCodigo></PrimPseudoCodigo>
                </Grid>
                <Grid item xs={2}>
                    <PRIMCamposAdicionais></PRIMCamposAdicionais>
                </Grid>
